...
import it.evadid.workbook.vm.types.BeDataType.AnyType
...
import it.evadid.workbook.vm.types.{AssigningNotPossible, AssigningPossibleWithImplicitCast, AssigningPossibleWithSameType, BeDataType}

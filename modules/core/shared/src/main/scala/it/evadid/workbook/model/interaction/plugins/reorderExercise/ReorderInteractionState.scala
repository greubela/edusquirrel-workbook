...
import it.evadid.workbook.model.interaction.plugins.reorderExercise.ReorderInteractionState.ReorderInteractionStateSerialized
import it.evadid.workbook.model.interaction.plugins.reorderExercise.ReorderType.CODELINES

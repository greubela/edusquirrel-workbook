...
case class PersonInsertedEvent(person: Person, router: Router, graph: EvaGraph, eventStartTimestamp: Long, val simulationStartedTimestampInMs: Long) extends PersonEvent{

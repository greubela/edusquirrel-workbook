...
final case class PythonEditorState(code: String) extends InteractionState {
  override def getStateAsString(): String = code
...
final case class PythonGradingState(codeSnapshot: String) extends InteractionState {
  override def getStateAsString(): String = codeSnapshot
}

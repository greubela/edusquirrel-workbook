package contentmanagement.htmlElements.genericElements.canvas

import contentmanagement.htmlElements.HtmlAppElement
import contentmanagement.model.color.AppColor
import contentmanagement.model.{AppFont, Bounds}
...
trait AppCanvas[C] extends HtmlAppElement {
  ...
  def drawImage(bounds: Bounds, img: FullImage, alphaUpTo255: Double): Unit = {
    drawImage(bounds.startX, bounds.startY, bounds.width, bounds.height, img, alphaUpTo255)
  }

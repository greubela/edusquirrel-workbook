SnapTranslator.dict.ua = { ...SnapTranslator.dict.ua,
    ...
    // embroidery blocks and stuff (gpt)
    'running stitch by _ steps':    'прямий стібок у _ кроків',
    'triple run by _':    'потрійний прямий стібок у _ кроків',
    'cross stitch in _ by _ center _':    'хрестик _ на _ по центру _',
    'zigzag with density _ width _ center _':    'зигзаг зі щільністю _ шириною _ по центру _',
    'Z-stitch with density _ width _ center _':    'Z-стібок зі щільністю _ шириною _ по центру _',
    'satin stitch with width _ center _':    'сатиновий стібок із шириною _ по центру _',
    'tatami stitch width _ interval _ center _':    'татамі-стібок із шириною _ інтервалом _ по центру _',
    'jump stitch _':    'перехідний стібок _',
    'tie stitch':    'закріплювальний стібок',
    'trim':    'обрізати нитку',
    'stop running':    'скинути налаштування вишивки',
    'draw text _ with size _':    'написати текст _ розміром _',
    'text length of _ with size _':    'довжина тексту _ при розмірі _',
    'rendering X-RAY ...':    'створення рентгенівського перегляду ...',
    'turn off X-RAY ...':    'вимкнення рентгенівського перегляду ...',
};
